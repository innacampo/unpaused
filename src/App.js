...
const App = () => {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'quiz':
        return (
          <div key={currentPage} className="flex flex-col items-center p-6 md:p-10">
      ...
      case 'chatbot':
        return (
          <div key={currentPage} className="relative flex flex-col h-[80vh] bg-white rounded-lg shadow-xl p-4 md:p-6 mx-auto max-w-2xl">
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans text-gray-800 flex flex-col">
      ...
      <main className="flex-1 p-4 md:p-8">
        <div key={currentPage} className="container mx-auto h-full overflow-y-auto">
          {renderPage()}
        </div>
      </main>
